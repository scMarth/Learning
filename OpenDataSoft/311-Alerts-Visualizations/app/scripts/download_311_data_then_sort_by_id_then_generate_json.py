...
for record in json_data:
    ...
    objid_list.append(record_id)
    json_data_hash[record_id] = record['fields']

# sort the object id list
...
with open(workspace + r'\visualization_data_cached_4.json', 'w') as outfile:
    json.dump(json_result, outfile)

# DEBUGGING

# for key in json_result:
#     debug_filename = workspace + r'\4_' + key + r'.json'
