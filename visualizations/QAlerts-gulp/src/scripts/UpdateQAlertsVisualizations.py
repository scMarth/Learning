...
workspace = r'\\vgisweb\visualizations\QAlerts\json'
...
parked_more_than_3_days_per_district = {}
...
for record in json_data:
    ...
    if district and typename:
        if typename == 'Parked More Than 3 Days (Public Property)':
            if district not in parked_more_than_3_days_per_district:
                parked_more_than_3_days_per_district[district] = 0
            parked_more_than_3_days_per_district[district] += 1
...
parked_more_than_3_days_per_district = sort_dict(parked_more_than_3_days_per_district)
...
json_result = {
    ...
    'parkedOver3DaysPerDistrict' : parked_more_than_3_days_per_district
}
