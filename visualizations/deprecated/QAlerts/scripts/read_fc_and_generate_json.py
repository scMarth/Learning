import requests, json, os, shutil, sys, datetime, decimal, functools, arcpy
...
# this is the fc that is generated via script when the data is pulled from the QScend API
fc = r"M:\GIS_Projects\Qscend\request_data\QScendRequestData.gdb\QScendRequestData"
...
with arcpy.da.SearchCursor(fc, '*') as cursor:
    for row in cursor:
        objid = row[0]
        qscend_data_hash[objid] = row

if not os.path.exists(workspace):
    os.makedirs(workspace)

'''
run script on local 311-data.json file, as generated by download_311_data.py
'''
...
for objid in qscend_data_hash:
    record = qscend_data_hash[objid]
...
json_result = {
    ...
    'numRecords' : len(qscend_data_hash),
...
with open(workspace + r'\visualization_data_cached_3.json', 'w') as outfile:
    json.dump(json_result, outfile)

print('===============================')
print('comparing with visualization_data_cached.json')
print('===============================')

with open(r'\\vgisdev\apps\visualizations\QAlerts\json\visualization_data_cached.json') as old_result:
    ...
    # print(old_json['typenameFreq'])
    # print(json_result['typenameFreq'])

print('===============================')
print('comparing with visualization_data_cached_2.json')
print('===============================')

with open(r'\\vgisdev\apps\visualizations\QAlerts\json\visualization_data_cached_2.json') as old_result:
    old_json = json.load(old_result)
